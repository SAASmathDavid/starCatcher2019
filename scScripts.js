    ...
    function starsUpdate () {
        ...
        for (var i = 0; i < badStarCount; i++) {
            ...
            if (badStarArray[i].visible()) {
                ...
                if (Math.abs(p1x-badStarArray[i]._x)<20 & Math.abs(p1y-badStarArray[i]._y)<20) {alert("you loser");}
                if (Math.abs(p2x-badStarArray[i]._x)<20 & Math.abs(p2y-badStarArray[i]._y)<20) {alert("you loser");}
            }
        }//endFor
    }  // close starsUpdate
